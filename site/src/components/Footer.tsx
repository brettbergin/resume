 ...
 * where they are. Matches the header's ring. */
const FOCUS_RING =
  'focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent'

/** A 44px-tall tap target (Tailwind's 11 = 2.75rem), the minimum comfortable
 * touch size. Width is left to the content so the links can wrap. */
const TAP_TARGET = 'min-h-11'

const LINK = `inline-flex ${TAP_TARGET} items-center gap-2 rounded-pill text-sm text-accent hover:underline ${FOCUS_RING}`
